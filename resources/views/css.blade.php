...
.btn-outline-secondary {
  color: {{$css->secondary}};
  border-color: {{$css->secondary}}; }

.btn-outline-secondary:hover {
  color: #fff;
  background-color: {{$css->secondary}};
  border-color: {{$css->secondary}}; }
...
.btn-outline-info {
  color: {{$css->info}};
  border-color: {{$css->info}}; }

.btn-outline-info:hover {
  color: #fff;
  background-color: {{$css->info}};
  border-color: {{$css->info}}; }
...
.bs-popover-bottom .popover-header::before, .bs-popover-auto[x-placement^="bottom"] .popover-header::before {
  ...
  margin-left: -0.5rem;
  content: "";
  border-bottom: 0 solid {{$css->primary}}; }
...
.bg-primary {
  background-color: {{$css->primary}} !important; }
...
.bg-secondary {
  background-color: {{$css->secondary}} !important; }
...
.bg-success {
  background-color: {{$css->success}} !important; }
...
.bg-info {
  background-color: {{$css->info}} !important; }
...
.bg-warning {
  background-color: {{$css->warning}} !important; }
...
.bg-danger {
  background-color: {{$css->danger}} !important; }
...
.bg-light {
  background-color: {{$css->light}} !important; }
...
.border-primary {
  border-color: {{$css->primary}} !important; }

.border-secondary {
  border-color: {{$css->secondary}} !important; }

.border-success {
  border-color: {{$css->success}} !important; }

.border-info {
  border-color: {{$css->info}} !important; }

.border-warning {
  border-color: {{$css->warning}} !important; }

.border-danger {
  border-color: {{$css->danger}} !important; }

.border-light {
  border-color: {{$css->light}} !important; }
...
.text-primary {
  color: {{$css->primary}} !important; }

a.text-primary:hover, a.text-primary:focus {
  color: #3321e9 !important; }

.text-secondary {
  color: {{$css->secondary}} !important; }

a.text-secondary:hover, a.text-secondary:focus {
  color: #5d6064 !important; }

.text-success {
  color: {{$css->success}} !important; }

a.text-success:hover, a.text-success:focus {
  color: #1b874b !important; }

.text-info {
  color: {{$css->info}} !important; }
...
.text-danger {
  color: {{$css->danger}} !important; }

a.text-danger:hover, a.text-danger:focus {
  color: #d71a1c !important; }

.text-light {
  color: {{$css->light}} !important; }
